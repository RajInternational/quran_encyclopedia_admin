...
Widget placeHolderWidget({double? height, double? width, BoxFit? fit, AlignmentGeometry? alignment, double? radius}) {
  return Image.asset('assets/icons/placeholder.jpg', height: height, width: width, fit: fit ?? BoxFit.cover, alignment: alignment ?? Alignment.center).cornerRadiusWithClipRRect(radius ?? defaultRadius);
}
...
Widget noDataWidget() {
  return Column(
    ...
    children: [
      Image.asset('assets/icons/no_data.png', height: 80, fit: BoxFit.fitHeight),
      8.height,
