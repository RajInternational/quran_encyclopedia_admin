...
import 'package:quizeapp/screens/admin/components/MediaLibraryWidget.dart';
        ...
        child: Column(
          ...
          children: [
            TabBar(
              ...
              tabs: [
                Tab(text: 'Library', icon: Icon(Icons.perm_media_outlined, color: Colors.black)),
                Tab(text: 'Upload', icon: Icon(Icons.upload_outlined, color: Colors.black)),
              ],
            ),
            TabBarView(
              controller: tabController,
