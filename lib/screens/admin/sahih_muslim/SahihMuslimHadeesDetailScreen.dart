...
class SahihMuslimHadeesDetailScreen extends StatefulWidget {
  final HadeesData? data;

  SahihMuslimHadeesDetailScreen({this.data});

  @override
  AddQuestionsScreenState createState() => AddQuestionsScreenState();
}

class AddQuestionsScreenState extends State<SahihMuslimHadeesDetailScreen> {
  ...
  //   hadeesData.createdAt = DateTime.now();
  //
  //   String hadeesDataJson = jsonEncode(hadeesData.toJson());
  //   await prefs.setString('hadeesData', hadeesDataJson);
  //
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            Text('Sahih Muslim Hadees Details', style: boldTextStyle()),
          ],
        ),
        actions: [],
      ),
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              16.height,
              // // shortInfoDetails("S No", TextDirection.ltr, sNoCont.text, TextDirection.ltr, "Poppins", 18),
              // 16.height,
              shortInfoDetails("Hadith No", TextDirection.ltr,
                  hadithNoCont.text, TextDirection.ltr, "Poppins", 18),
              16.height,
              // shortInfoDetails("Kitab ID", TextDirection.ltr, kitabIdCont.text, TextDirection.ltr, "Poppins", 18),
              // 16.height,
              shortInfoDetails("Kitab", TextDirection.ltr, kitabCont.text,
                  TextDirection.ltr, "Poppins", 18),
              16.height,
              // shortInfoDetails("Baab ID", TextDirection.ltr, baabIdCont.text, TextDirection.ltr, "Poppins", 18),
              // 16.height,
              shortInfoDetails("Baab", TextDirection.ltr, baabCont.text,
                  TextDirection.ltr, "Poppins", 18),
              16.height,
              // shortInfoDetails("Book in Arabic", TextDirection.ltr, bookInArabicCont.text, TextDirection.rtl, "ArabicFonts", 18),
              // 16.height,
              // shortInfoDetails("Book in English", TextDirection.ltr, bookInEnglishCont.text, TextDirection.ltr, "Poppins", 18),
              // 16.height,
